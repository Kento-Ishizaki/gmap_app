...
<div class="container mt-3">
    ...
    <form action="{{ route('map.update', ['map' => $map]) }}" method="POST" name="editForm">
    @csrf
    @method('PUT')
        <div class="modal-body">
            ...
            <button type="submit" class="btn btn-outline-primary w-50 mb-2">編集</button>
            <button type="submit" class="btn btn-outline-danger w-50">削除</button>
        </div>
    </form>
</div>
@endsection
